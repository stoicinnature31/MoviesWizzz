    ...
    >
      ...
      >
        <Flex
          ...
          flexWrap="wrap"
        >
          <FooterSection title="Company Name" items={['Home', 'About Us', 'Contacts', 'Movies']} />
          <FooterSection title="Top Categories" items={['Action', 'Romance', 'Drama', 'Adventure']} newItems={['Things To Do']} />
          <FooterSection title="My Account" items={['Dashboard', 'My Favourites', 'My profile', 'Change Password']} />
          <SocialLinks />
        </Flex>
      </Box>
      <Flex
      ...
      >
        ...
        <Text color="gray.600" fontSize="0.875rem" pl={{ base: '0', md: '0.5rem' }} mt={{ base: '1rem', md: '0' }}>
